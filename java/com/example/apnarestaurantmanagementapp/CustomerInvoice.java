...
public class CustomerInvoice extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        recyclerView=findViewById(R.id.rcInoviceOrdersView);
        btnBack=findViewById(R.id.btnInvoiceBack);
        tv1=findViewById(R.id.tvInvoiceTitle);
        ...
        btnBack.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(CustomerInvoice.this, AddPOS.class);
